...
<div class="tabs-container products_tabs">
	<ul class="tabs">
		<?php
			...
			{
				echo "<li><h4><a href=\"#tab-must-have\" title=\"" . apply_filters( 'yit_product_tabs_must_have_title', __('Must Have', 'yit') ) . "\">" . apply_filters( 'yit_product_tabs_must_have_title', __('Must Have', 'yit') ) . "</a></h4></li>";
				if($slider == "yes")
			...
			{
				echo "<li><h4><a href=\"#tab-best-seller\" title=\"" . apply_filters( 'yit_product_tabs_best_sellers_title', __('Best Seller', 'yit') ) . "\">" . apply_filters( 'yit_product_tabs_best_sellers_title', __('Best Seller', 'yit') ) . "</a></h4></li>";
				if($slider == "yes")
			...
			{
				echo "<li><h4><a href=\"#tab-special-offers\" title=\"" . apply_filters( 'yit_product_tabs_special_offers_title', __('Special Offers', 'yit') ) . "\">" . apply_filters( 'yit_product_tabs_special_offers_title', __('Special Offers', 'yit') ) . "</a></h4></li>";
				if($slider == "yes")
