...
function yit_sidebar_title_font_style( $array ) {
    $array['selectors'] .= '.sidebar .cta .border h3, .sidebar .yit_quick_contact h3';
    return $array;
}
...
function yit_sidebar_links_font_selector( $selectors ) {
    $selectors .= ',.last-tweets p a,.recent-comments .the-post .author a';
    return $selectors;
}
...
function yit_sidebar_links_hover_font_selectors( $selectors ) {
    $selectors .= ',.recent-comments .the-post .author a:hover,.sidebar .recent-post .text > a:hover,.widget.widget_layered_nav li a:hover,.widget_product_categories .product-categories li a:hover,.widget.widget_onsale li a:hover,.widget.widget_best_sellers li a:hover,.widget.widget_recent_reviews li a:hover,.widget.widget_recent_products li a:hover,.widget.widget_random_products li a:hover,.widget.widget_featured_products li a:hover,.widget.widget_top_rated_products li a:hover,.widget.widget_recently_viewed_products li a:hover';
    return $selectors;
}
